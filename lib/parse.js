...
//     (optionally with a second pm2 --time timestamp prefixed, and ANSI colour)
...
// reader.js colourises its output (chalk) and pm2 keeps the escape codes in the
// log file. Strip CSI sequences (ESC "[" ... final-byte) so parsing sees text.
...
module.exports = { parsePages, recentPages, stripAnsi };
